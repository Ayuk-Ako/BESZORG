...
<body>
  ...
  <aside class="glass-sidebar" id="sidebar">
    ...
    <div class="px-3">
      ...
      <nav class="side-nav d-grid gap-1" id="sideNav">
        ...
        <a href="logs.php" class="active"><i class="bi bi-file-earmark-text"></i> Activity Logs</a>
      </nav>
  ...
  <div class="d-flex align-items-center justify-content-between mb-4">
    ...
    <small class="text-muted">Track all recent actions</small>
  </div>
  ...
  <div class="card shadow-sm">
    ...
    <div class="card-body p-0">
      <ul class="list-group list-group-flush" id="activityLog">
        <!-- JS log() will prepend <li> entries here -->
      </ul>
    </div>
  </div>
</div>
