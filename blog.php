...
<head>
  ...
  <title>BESZORG • Blog</title>
  <meta name="description" content="Read the latest wellness articles and updates from BESZORG." />
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="mainNav">
      <ul class="navbar-nav ms-auto d-flex align-items-lg-center gap-lg-2">
        ...
        <li class="nav-item"><a href="blog.php" class="nav-link active"><i class="bi bi-journal-text"></i> Blog</a></li>
...
<main>
  ...
  <section class="hero section">
    <div class="container text-center">
      ...
      <p class="lead text-secondary">Wellness tips, healthy living guides, and BESZORG updates.</p>
    </div>
  </section>
      ...
      <div class="row g-4">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="card h-100">
            <img src="https://images.unsplash.com/photo-1605296867304-46d5465a13f1?q=80&w=1200&auto=format&fit=crop" class="card-img-top" alt="Healthy Eating">
            <div class="card-body d-flex flex-column">
              <h5 class="card-title">5 Simple Healthy Eating Habits</h5>
              <p class="card-text">Discover easy daily practices that can transform your diet and overall wellness.</p>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="card h-100">
            <img src="https://images.unsplash.com/photo-1518609878373-06d740f60d8b?q=80&w=1200&auto=format&fit=crop" class="card-img-top" alt="Mental Wellness">
            <div class="card-body d-flex flex-column">
              <h5 class="card-title">The Power of Mental Wellness</h5>
              <p class="card-text">Why taking care of your mind is just as important as your physical health.</p>
              <a href="#" class="btn btn-outline-success mt-auto">Read More</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="card h-100">
            <img src="https://images.unsplash.com/photo-1605296867724-3004c0d1a1d4?q=80&w=1200&auto=format&fit=crop" class="card-img-top" alt="Exercise Routine">
            <div class="card-body d-flex flex-column">
              <h5 class="card-title">Creating an Exercise Routine</h5>
              <p class="card-text">Learn how to set realistic fitness goals and stick to them long term.</p>
              <a href="#" class="btn btn-outline-success mt-auto">Read More</a>
            </div>
          </div>
        </div>
